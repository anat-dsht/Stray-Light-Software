...
class CalibratorTab(StrayLightTreatment):
    ...
    def call_functions_calibrator(self):
        ...
        for file_path in file_paths:
            ...
            self.get_graph_parameters_calibrator(file_path)
    ...
    def scans_comparison_calibrator(self):
        ...
        self.barycenter_processor_calibrator = ScansComparison(
            ...
            self.scans_done_calibrator, self.freqs_calibrator, self.freqs_calibrator_51, self.data_calibrator, self.data_calibrator_51,
    ...
    def low_scans_comparison_calibrator(self):
        ...
        self.barycenter_processor_calibrator = ScansComparison(
            ...
            self.low_quality_y_SL, self.low_quality_x_perturbation, self.low_quality_y_perturbation, self.low_list_straylight_max51,
