...
class VisualisationTab(QWidget):
    ...
    def get_graph_parameters(self, final_path: object) -> object:
        """
        ...
        if self.tab_name == 'VisualisationTab':
            ...
            self.qpr = graph_manager.legend_qpr(self.data_vdc)
    ...
    def get_graph_parameters_calibrator(self, final_path: object, canal:str="/'Group Name'/'AI 55'") -> object:
        """
        Get graph's parameters from GraphManager class.
    ...
    def get_graph_parameters_scan0(self, final_path: object) -> object:
        """
        Get graph's parameters from GraphManager class.
    ...
    def get_graph_parameters_scan0P(self, final_path: object) -> object:
        """
        Get graph's parameters from GraphManager class.
