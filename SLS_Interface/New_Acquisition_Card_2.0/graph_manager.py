...
class GraphManager:
    ...
    def get_canal(self, count, from_get_graph_parameters=False, from_get_graph_parameters_bis=False,
                  from_get_graph_parameters_calibrator=False, from_get_graph_parameters_reference_calibrator=False):
        """
        ...
        elif from_get_graph_parameters_bis:
            self.canal = f"/'Group Name'/'AI {self.value}'"
            self.canal_index = self.value
            if count % 2 != 0:
                self.value += 1
            else:
                self.value = self.value

        elif from_get_graph_parameters_reference_calibrator :
            self.canal = 'Canal A'
            self.canal_index = 1

        elif from_get_graph_parameters_calibrator :
            self.canal = f"/'Group Name'/'AI 12'"
            self.canal_index = 1
