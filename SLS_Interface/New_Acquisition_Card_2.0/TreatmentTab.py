...
X_CONDITION_BARYCENTER_COMPARISON = 2e-4  #on aimerait plutôt 1e-4
...
class StrayLightTreatment(VisualisationTab):
    ...
    def __init__(self, initialize_connections=False):
        ...
        self.line_color_51: Optional[str] = None
        ...
        self.scans_comparison_treated_signal_x_51_spec_freq: List[List[float]] = []
        ...
        self.low_scans_comparison_treated_signal_x_51_spec_freq: List[List[float]] = []
        ...
        self.scans_comparison_treated_signal_x_spec_freq_tot: List[List[float]] = []
        self.scans_comparison_treated_signal_x_51_spec_freq_tot: List[List[float]] = []
        ...
        self.button_treat_all_signals: QPushButton = QPushButton("Treat all signals")
        ...
        self.checkbox_data_plotline_53: QCheckBox = QCheckBox("Scan 53 plot")
        self.checkbox_data_plotline_51: QCheckBox = QCheckBox("Scan 51 plot")
        self.checkbox_barycenters_53: QCheckBox = QCheckBox("Barycenters 53")
        self.checkbox_barycenters_51: QCheckBox = QCheckBox("Barycenters 51")
        self.checkbox_treated_signal_53: QCheckBox = QCheckBox("Treated signal 53")
        self.checkbox_treated_signal_51: QCheckBox = QCheckBox("Treated signal 51")
        self.checkbox_noise_floor_53: QCheckBox = QCheckBox("Noise floor 53")
        self.checkbox_noise_floor_51: QCheckBox = QCheckBox("Noise floor 51")
    ...
    def setup_traitement_ui(self):
        ...
        self.layout.addWidget(self.button_treat_all_signals, 2, 0)
        self.layout.addWidget(self.button_access_data, 3, 0)
        ...
        self.plot_options_layout.addWidget(self.checkbox_noise_floor_53, 0, 0)
        self.plot_options_layout.addWidget(self.checkbox_noise_floor_51, 0, 1)
        self.plot_options_layout.addWidget(self.checkbox_barycenters_53, 1, 0)
        self.plot_options_layout.addWidget(self.checkbox_barycenters_51, 1, 1)
        self.plot_options_layout.addWidget(self.checkbox_data_plotline_53, 2, 0)
        self.plot_options_layout.addWidget(self.checkbox_data_plotline_51, 2, 1)
        self.plot_options_layout.addWidget(self.checkbox_treated_signal_53, 3, 0)
        self.plot_options_layout.addWidget(self.checkbox_treated_signal_51, 3, 1)
        self.parameter_layout.addLayout(self.plot_options_layout, 8, 1, 1, 2)

        # Initialize the plotting options checkboxes states
        self.checkbox_noise_floor_53.setChecked(True)
        self.checkbox_noise_floor_51.setChecked(True)
        self.checkbox_data_plotline_53.setChecked(True)
        self.checkbox_data_plotline_51.setChecked(True)
        self.checkbox_barycenters_53.setChecked(True)
        self.checkbox_barycenters_51.setChecked(True)
        self.checkbox_treated_signal_53.setChecked(True)
        self.checkbox_treated_signal_51.setChecked(True)
    ...
    def setup_connections_sl(self):
        ...
        # Call the main function to process all the signals
        self.button_treat_all_signals.clicked.connect(self.call_functions_bis)
    ...
    def call_functions(self):
        ...
        if self.count != 0:
            ...
            if msg_box.clickedButton() == clear_plot_button:
                ...
                self.list_perturbation_max51_tot = []
                self.list_perturbation_max53_tot = []
        ...
        for file_path in file_paths:
            ...
            self.get_graph_parameters(file_path, self.count, from_classic_treatment=True)
        ...
        print(f'len(self.list_perturbation_max51_tot) = {len(self.list_perturbation_max51_tot[-1])}')
        ...
        scans_comparison_treated_signal_x_spec_freq_tot = (self.low_scans_comparison_treated_signal_x_spec_freq[-1] +
                                                           self.scans_comparison_treated_signal_x_spec_freq[-1])

        self.scans_comparison_treated_signal_x_spec_freq_tot.append(scans_comparison_treated_signal_x_spec_freq_tot)

        scans_comparison_treated_signal_x_51_spec_freq_tot = (
                    self.low_scans_comparison_treated_signal_x_51_spec_freq[-1] +
                    self.scans_comparison_treated_signal_x_51_spec_freq[-1])

        self.scans_comparison_treated_signal_x_51_spec_freq_tot.append(
            scans_comparison_treated_signal_x_51_spec_freq_tot)
    ...
    def call_functions_bis(self):
        ...
        for i in range(41):
            ...
            for file_path in file_paths:
                ...
                # Get the canal, linked data and legends for the current scan treated
                self.get_graph_parameters(file_path, self.count)
                self.record_type = add_legends(file_path)
            ...
            scans_comparison_treated_signal_x_spec_freq_tot = (
                        self.low_scans_comparison_treated_signal_x_spec_freq[-1] +
                        self.scans_comparison_treated_signal_x_spec_freq[-1])
    ...
    def call_functions_other_spectrum(self, files):
        ...
        for file in files:
            ...
            if 'dark' in file.lower():
                ...
                self.file_df_dark, self.file_vdc_df_dark = self.link_vdc_to_canal(file)
                ...
                self.file_df_noscan, self.file_vdc_df_noscan = self.link_vdc_to_canal(file)
                ...
                # Get the canal, linked data and legends for the current scan treated
                self.get_graph_parameters_scan0P(file, self.count)
                ...
                # Get the canal, linked data and legends for the current scan treated
                self.get_graph_parameters_scan0(file, self.count)
                self.record_type = add_legends(file)
    ...
    def treatment_method_dark(self, bandwidth):
        ...
        if self.yaxis_scrollbox.currentText() == "Fractional amplitude":
            ...
            vdc_value = vdc_values[-1]
            self.data_dark = self.file_vdc_df_dark[mask].reset_index(drop=True)*vdc_value
    ...
    def low_treatment_method_dark(self, bandwidth):
        ...
        if self.yaxis_scrollbox.currentText() == "Fractional amplitude":
            ...
            self.low_data_dark = self.file_df_dark[mask].reset_index(drop=True)
    ...
    def treatment_method_noscan(self, bandwidth):
        ...
        if self.yaxis_scrollbox.currentText() == "Fractional amplitude":
            ...
            vdc_values = self.data_vdc['VDC'].values
            vdc_value = vdc_values[-1]
            self.data_noscan = self.file_vdc_df_noscan[mask].reset_index(drop=True)*vdc_value
    ...
    def treatment_method_scan0(self, bandwidth):
        ...
        # Compute the noise floor of the signal
        self.noise_floor_freqs_scan0, self.noise_floor_values_scan0 = self.riemann_method(bandwidth, self.freqs_scan0,
                                                                                          self.data_scan0)
    ...
    def low_treatment_method_noscan(self, bandwidth):
        ...
        if self.yaxis_scrollbox.currentText() == "Fractional amplitude":
            ...
            self.low_data_noscan = self.file_df_noscan[mask].reset_index(drop=True)
    ...
    def low_treatment_method_scan0(self, bandwidth, bandwidth_noise_model):
        """
        Process noise floor, clusters, peak detection, barycenter for noscan acquisition for low frequencies.
        ...
        self.log_fit_amplitude_optimal_scan0, self.fit_amplitude_optimal_scan0 = self.create_noise_model(
            bandwidth_noise_model, self.low_freqs_scan0, self.low_data_scan0, self.log_freqs_scan0,
             self.log_data_scan0)
    ...
    def low_treatment_method_scan0P(self, bandwidth, bandwidth_noise_model):
        """
        Process noise floor, clusters, peak detection, barycenter for noscan acquisition for low frequencies.
        ...
        self.log_fit_amplitude_optimal_scan0P, self.fit_amplitude_optimal_scan0P = self.create_noise_model(
            bandwidth_noise_model, self.low_freqs_scan0P, self.low_data_scan0P, self.log_freqs_scan0P,
    ...
    def low_treatment_method(self, bandwidth, bandwidth_noise_model):
        """
        ...
        self.log_fit_amplitude_optimal, self.fit_amplitude_optimal = self.create_noise_model(
            bandwidth_noise_model, self.low_freqs, self.low_data, self.log_freqs, self.log_data)
    ...
    def analyse_data(self):
        ...
        for i in range(len(self.barycenters_list) // 2):
            ...
            # ----------------------------------------------------------------------------------------------------------
            # Scan 5.1
            data_treated_signal_51[self.legends[i] + " X-component Treated signal OPD"] = (
                self.scans_comparison_treated_signal_x_tot_51)[i]
            data_treated_signal_51[self.legends[i] + " X-component Treated signal frequency"] = (
                self.scans_comparison_treated_signal_x_51_spec_freq_tot)[i]
            data_treated_signal_51[self.legends[i] + " Y-component Treated signal"] = (
                self.scans_comparison_treated_signal_y_tot_51)[i]
            '''data_treated_signal_51[""] = ""
            data_treated_signal_51["Dark frequencies"] = (self.freqs_dark)[i]
            data_treated_signal_51["Dark data"] = (self.data_dark)[i]'''

            # ----------------------------------------------------------------------------------------------------------
            # Scan 5.3
            data_treated_signal[self.legends[i] + " X-component Treated signal OPD"] = (
                self.scans_comparison_treated_signal_x_tot)[i]
            data_treated_signal[self.legends[i] + " X-component Treated signal frequency"] = (
                self.scans_comparison_treated_signal_x_spec_freq_tot)[i]
        ...
        try:
            ...
            file_path_barycenter = f'Barycenter_data_{self.legends[i][15:]}.xlsx'
            ...
            print(f"Barycenter are now accessible in 'Barycenter_data_{self.legends[i][15:]}.xlsx'.")

            # Save treated signal dataframe into Excel file
            file_path_treated_signal = f'Treated_signal_data_{self.legends[i][15:]}.xlsx'
            with pd.ExcelWriter(file_path_treated_signal, engine='openpyxl') as writer:
                ...
                df_treated_signal.to_excel(writer, sheet_name='Treated signal Scan53', index=False)
            print(f"Treated signal's data are now accessible in 'Treated_signal_data_{self.legends[i][15:]}.xlsx'.")
    ...
    def analyse_data_bis(self):
        ...
        for i in range(41):
            ...
            # ----------------------------------------------------------------------------------------------------------
            # Scan 5.1
            data_treated_signal_51[f"{i} X-component Treated signal OPD"] = (
                self.scans_comparison_treated_signal_x_tot_51)[i]
            data_treated_signal_51[f"{i} X-component Treated signal frequency"] = (
                self.scans_comparison_treated_signal_x_51_spec_freq_tot)[i]
            data_treated_signal_51[f"{i} Y-component Treated signal"] = (
                self.scans_comparison_treated_signal_y_tot_51)[i]

            # ----------------------------------------------------------------------------------------------------------
            # Scan 5.3
            data_treated_signal[f"{i} X-component Treated signal OPD"] = (
                self.scans_comparison_treated_signal_x_tot)[i]
            data_treated_signal[f"{i} X-component Treated signal frequency"] = (
                self.scans_comparison_treated_signal_x_spec_freq_tot)[i]
            data_treated_signal[f"{i} Y-component Treated signal"] = (
                self.scans_comparison_treated_signal_y_tot)[i]
        ...
        try:
            ...
            # Save barycenter dataframe into Excel file
            file_path_barycenter = f'Barycenter_data_all_signals.xlsx'
            with pd.ExcelWriter(file_path_barycenter, engine='openpyxl') as writer:
                df_51_SL_peaks.to_excel(writer, sheet_name='Scan51 SL peaks', index=False)
                df_51_perturbation_peaks.to_excel(writer, sheet_name='Scan51 perturbation peaks', index=False)
                df_53_SL_peaks.to_excel(writer, sheet_name='Scan53 SL peaks', index=False)
                df_53_perturbation_peaks.to_excel(writer, sheet_name='Scan53 perturbation peaks', index=False)
            print(f"Barycenter are now accessible in 'Barycenter_data_all_signals.xlsx'.")

            # Save treated signal dataframe into Excel file
            file_path_treated_signal = f'Treated_signal_data_all_signals.xlsx'
            with pd.ExcelWriter(file_path_treated_signal, engine='openpyxl') as writer:
                df_treated_signal_51.to_excel(writer, sheet_name='Treated signal Scan51', index=False)
                df_treated_signal.to_excel(writer, sheet_name='Treated signal', index=False)
            print(f"Treated signal's data are now accessible in 'Treated_signal_data_all_signals.xlsx'.")
    ...
    def get_custering_low_variables(self, noise_floor_values):
        ...
        if self.count % 2 == 0:
            low_xpeak, low_ypeak, low_peak_width_51, self.peak_threshold = self.detect_peaks_above_noise_model(noise_floor_values,
            ...
            low_xpeak, low_ypeak, low_peak_width_53, self.peak_threshold = self.detect_peaks_above_noise_model(noise_floor_values,
                                                                                        self.low_freqs, self.low_data)
    ...
    def scans_comparison(self):
        ...
        self.scans_comparison_treated_signal_x_spec_freq = [
            [x / 5.656e-2 for x in sublist]
            for sublist in self.scans_comparison_treated_signal_x
        ]

        self.scans_comparison_treated_signal_x_51_spec_freq = [
            [x / 5.656e-2 for x in sublist]
            for sublist in self.scans_comparison_treated_signal_x_51
        ]
    ...
    def low_scans_comparison(self):
        ...
        self.low_scans_comparison_treated_signal_x_spec_freq = [
            [x / 5.656e-2 for x in sublist]
            for sublist in self.low_scans_comparison_treated_signal_x
        ]

        self.low_scans_comparison_treated_signal_x_51_spec_freq = [
            [x / 5.656e-2 for x in sublist]
            for sublist in self.low_scans_comparison_treated_signal_x_51
        ]
    ...
    def create_plot_sl(self, xaxis: object, yaxis: object, xlabel: object, ylabel: object, canal: object) -> object:
        ...
        # Utilisation d'une expression régulière pour extraire "AI ..."
        ...
        if self.checkbox_data_plotline_51.isChecked():
            '''if self.count % 2 ==0 :
                handle = sns.lineplot(x=xaxis, y=yaxis, ax=self.ax, linewidth=1.5, alpha=0)
            else:
            ...
            # Get the color of the last plotted line to maintain consistency
            line_handle = handle.get_lines()[-1]
            self.line_color_51 = line_handle.get_color()

        else:
            self.line_color_51 = None

        # --------------------------------------------------------------------------------------------------------------
        # 5.1 Barycenter plot

        if self.checkbox_barycenters_51.isChecked():
            ...
            if all_barycenters.size > 0:
                handle = sns.scatterplot(x=all_barycenters[:, 0], y=all_barycenters[:, 1], ax=self.ax, s=50,
                                         color=self.line_color_51,
        ...
        if self.checkbox_noise_floor_51.isChecked():

            sns.lineplot(x=self.noise_floor_freqs, y=self.noise_floor_values, ax=self.ax, color=self.line_color_51,
            ...
            sns.lineplot(x=self.low_freqs, y=self.peak_threshold, ax=self.ax, color=self.line_color_51)
    ...
    def overlay_filtered_plot(self):
        ...
        def add_overlay_plot(x_data, y_data, canal):
            ...
            if not self.scans_done:
                ...
                if self.count % 2 != 0:
                    if self.checkbox_data_plotline_53.isChecked():
                    ...
                    print("entrée dans la boucle 51")
                    if self.checkbox_data_plotline_51.isChecked():
                        # Plot the data with a specific label and store the color of the plot line.
                        handle_51 = sns.lineplot(x=x_data, y=y_data, ax=self.ax, linewidth=1.5,
                                              label=label)
                        line_handle_51 = handle_51.get_lines()[-1]
                        self.line_color_51 = line_handle_51.get_color()
                ...
                if self.count % 2 != 0:
                    if self.checkbox_barycenters_53.isChecked():
                        ...
                        if all_barycenters.size > 0:
                            ...
                            sns.scatterplot(x=all_barycenters[:, 0], y=all_barycenters[:, 1], ax=self.ax, s=50,
                ...
                if self.count % 2 != 0 :
                    if self.checkbox_noise_floor_53.isChecked():

                        sns.lineplot(x=self.noise_floor_freqs, y=self.noise_floor_values, ax=self.ax, color=self.line_color,
                                     label=[f"Noise floor {self.record_type[:8]}"])
                        sns.lineplot(x=self.low_freqs, y=self.peak_threshold, ax=self.ax, color=self.line_color)

                else:
                    if self.checkbox_noise_floor_51.isChecked():
                        sns.lineplot(x=self.noise_floor_freqs, y=self.noise_floor_values, ax=self.ax,
                                     color=self.line_color_51,
                                     label=[f"Noise floor {self.record_type[:8]}"])
                        sns.lineplot(x=self.low_freqs, y=self.peak_threshold, ax=self.ax, color=self.line_color_51)
            # ==========================================================================================================
            # If scans have been completed, adjust the plot based on the treated signal.
                ...
                '''sns.scatterplot(x=self.scans_comparison_treated_signal_x_tot[-1],
                                y=self.scans_comparison_treated_signal_y_tot[-1], ax=self.ax, s=50,
                                color="green",
                                label=f"Scan 5,3GHz/s, "f"{self.folder_scrollbox_sl.currentText()[:8]}, "
                                      f"{self.qpr}, treated signal", alpha=1, edgecolor='none')'''

                if self.checkbox_treated_signal_53.isChecked():
                ...
                if self.checkbox_treated_signal_51.isChecked():

                    if self.line_color_51 is not None:

                        # Modify the color for the treated signal by adjusting the RGB values of the existing line color
                        r, g, b = (int(self.line_color_51[1:3], 16), int(self.line_color_51[3:5], 16),
                               int(self.line_color_51[5:], 16))
                        r = min(max(r + int(100 / random.randint(1, 4)), 0), 255)
                        g = min(max(g - int(200 / random.randint(1, 4)), 0), 255)
                        b = min(max(b - int(200 / random.randint(1, 4)), 0), 255)
                        ...
                        # Scatter plot the treated signal with the new color.
                        sns.scatterplot(x=self.scans_comparison_treated_signal_x_tot_51[-1],
                                    y=self.scans_comparison_treated_signal_y_tot_51[-1], ax=self.ax, s=50,
                                    color=new_hex_color,
                                    label=f"Scan 5,1GHz/s, "f"{self.folder_scrollbox_sl.currentText()[:8]}, "
                                          f"{self.qpr}, treated signal")
        ...
        # Call of functions to plot in the data_analysis tab
                ...
                if self.checkbox_data_plotline_51.isChecked() or self.checkbox_data_plotline_53.isChecked():
                ...
                self.data_analysis_tab.compare_pos_plot(self.y_max_values_list, self.y_ratio_values_list,
                                                        self.plot_colors,
                                                        'Comparison of y ratio and y max (Barycenters over 3 pts)',
                ...
                self.data_analysis_tab.compare_pos_plot(self.y_max_values_list, self.quality_x_SL_list,
                                                        self.plot_colors,
                                                        'Comparison of x ratio and y max (Barycenters over 3 pts)',
                                                        'y max values',
                                                        '|x51/x53 - 1|',
                                                        self.list_labels, 2, self.count / 2)
