...
class VisualisationTab(QWidget):
    ...
    def __init__(self, initialize_connections=True):
        ...
        self.data_vdc_dark: Optional[pd.DataFrame] = None
    ...
    def setup_ui(self):
        ...
        self.canal_listwidget.addItems(["AI 0", "AI 1", "AI 2",
                                        "AI 3", "AI 4", "AI 5",
                                        "AI 6", "AI 7", "AI 8",
                                        "AI 9", "AI 10", "AI 11",
                                        "AI 12", "AI 13", "AI 14",
    ...
    def construct_final_path(self):
        ...
        if os.path.isdir(final_path):
            # Enter the folder specified by temporal_or_frequential within the directory
            sub_path = os.path.join(final_path, temporal_or_frequential)
            if not os.path.isdir(sub_path):
                raise FileNotFoundError(f"The '{temporal_or_frequential}' folder was not found in: {final_path}")

            # Look for CSV files in the sub-path
            csv_files = [f for f in os.listdir(sub_path) if f.endswith('.csv')]
            if not csv_files:
                raise FileNotFoundError(f"No CSV file found in the '{temporal_or_frequential}' folder: {sub_path}")

            # Use the first CSV file found
            final_path = os.path.join(sub_path, csv_files[0])
    ...
    def link_vdc_to_canal(self, path: object) -> object:
        ...
        if not os.path.isdir(parent_path):
            raise FileNotFoundError(f"Le répertoire parent est introuvable : {parent_path}")
        ...
        for file in list_files:
            ...
            if "RawData" in file_path:
                ...
                df = pd.read_csv(file_path, usecols=["/'Group Name'/'AI 0'", "/'Group Name'/'AI 1'", "/'Group Name'/'AI 2'",
                                                     "/'Group Name'/'AI 3'", "/'Group Name'/'AI 4'", "/'Group Name'/'AI 5'",
                                                     "/'Group Name'/'AI 6'", "/'Group Name'/'AI 7'", "/'Group Name'/'AI 8'",
                                                     "/'Group Name'/'AI 9'", "/'Group Name'/'AI 10'", "/'Group Name'/'AI 11'",
                                                     "/'Group Name'/'AI 12'", "/'Group Name'/'AI 13'", "/'Group Name'/'AI 14'",
                                                     "/'Group Name'/'AI 15'", "/'Group Name'/'AI 16'", "/'Group Name'/'AI 17'",
                                                     "/'Group Name'/'AI 18'", "/'Group Name'/'AI 19'", "/'Group Name'/'AI 20'",
                                                     "/'Group Name'/'AI 21'", "/'Group Name'/'AI 22'", "/'Group Name'/'AI 23'",
                                                     "/'Group Name'/'AI 32'", "/'Group Name'/'AI 33'", "/'Group Name'/'AI 34'",
                                                     "/'Group Name'/'AI 35'", "/'Group Name'/'AI 36'", "/'Group Name'/'AI 37'",
                                                     "/'Group Name'/'AI 38'", "/'Group Name'/'AI 39'", "/'Group Name'/'AI 48'",
                                                     "/'Group Name'/'AI 49'", "/'Group Name'/'AI 50'", "/'Group Name'/'AI 51'",
                                                     "/'Group Name'/'AI 52'", "/'Group Name'/'AI 53'", "/'Group Name'/'AI 54'",
                                                     "/'Group Name'/'AI 55'"], delimiter=" ")

            '''
            elif "Scan51_Calib-Scan0p" in file_path:
                df = pd.read_csv(file_path, usecols=["/'Group Name'/'AI 12'", "/'Group Name'/'AI 13'",
                                                     "/'Group Name #1'/'AI 12'", "/'Group Name #1'/'AI 13'",
                                                     "/'Group Name #2'/'AI 12'", "/'Group Name #2'/'AI 13'",
                                                     "/'Group Name #3'/'AI 12'", "/'Group Name #3'/'AI 13'"],
                                                      delimiter=" ")

            elif "Scan51_Calib-Scan0" in file_path:
                df = pd.read_csv(file_path, usecols=["/'Group Name'/'AI 12'", "/'Group Name'/'AI 13'"],
                                                    delimiter=" ")

            elif "Scan53_Calib-Scan0" in file_path:
                df = pd.read_csv(file_path, usecols=["/'Group Name'/'AI 12'", "/'Group Name'/'AI 13'"],
                                                    delimiter=" ")
        ...
        file_df = self.dataframes[file_plotted][self.canal]
    ...
    def get_graph_parameters(self, final_path: object, count, from_classic_treatment=False) -> object:
        """
        Get graph's parameters from GraphManager class.

        :param final_path: Path of the plotted signal.
        :param count:
        :param: from_classic_treatment
        ...
        if self.graph_manager is None:
            self.graph_manager: GraphManager = GraphManager(self.x_axis_scrollbox, self.yaxis_scrollbox, self.analysis,
                                                   self.canal_listwidget, self.x_axis_legends, self.x_axis_legend,
                                                   self.y_axis_legends, self.y_axis_legend, self.x_axis_datas,
                                                   self.x_axis_data, self.qpr, self.xaxis_min,
        ...
        # Get canal value
        if from_classic_treatment:
            self.canal = self.graph_manager.get_canal(count, from_get_graph_parameters=True)
        else:
            self.canal = self.graph_manager.get_canal(count, from_get_graph_parameters_bis=True)

        # Get X-axis information
        (self.xaxis_min, self.xaxis_max, self.low_xaxis_min, self.low_yaxis_min, self.x_axis_legend,
         self.x_axis_data) = self.graph_manager.choose_x_axis(final_path)

        _, file_vdc_df = self.link_vdc_to_canal(final_path)

        # --------------------------------------------------------------------------------------------------------------
        # Get pico information
        self.qpr= self.graph_manager.legend_qpr(self.data_vdc)
        ...
        (self.xaxis, self.yaxis, self.low_xaxis, self.low_yaxis,
         self.y_axis_legend) = execute_with_error_handling(self.graph_manager.choose_y_axis, file_vdc_df)
    ...
    def get_graph_parameters_calibrator(self, final_path: object, count) -> object:
        """
        Get graph's parameters from GraphManager class.
        ...
        graph_manager: GraphManager = GraphManager(self.x_axis_scrollbox, self.yaxis_scrollbox, self.analysis_calibrator,
                                                   ...
                                                   self.x_axis_data_calibrator, self.qpr,
        ...
        # Get canal value
        if count % 2 == 0:
            self.canal = graph_manager.get_canal(count, from_get_graph_parameters_calibrator=True)
        else:
            self.canal = graph_manager.get_canal(count, from_get_graph_parameters_reference_calibrator=True)
    ...
    def get_graph_parameters_scan0(self, final_path: object, count) -> object:
        """
        Get graph's parameters from GraphManager class.

        :param final_path: Path of the plotted signal.
        :param count: Pico chose by the user.
        ...
        graph_manager: GraphManager = GraphManager(self.x_axis_scrollbox, self.yaxis_scrollbox, self.analysis_scan0,
                                                   ...
                                                   self.x_axis_legend, self.y_axis_legends,
                                                   self.y_axis_legend, self.x_axis_datas,
                                                   self.x_axis_data_scan0, self.qpr,
        ...
        # Get canal value
        self.canal_scan0 = graph_manager.get_canal(count)
    ...
    def get_graph_parameters_scan0P(self, final_path: object, count) -> object:
        """
        Get graph's parameters from GraphManager class.
        ...
        graph_manager: GraphManager = GraphManager(self.x_axis_scrollbox, self.yaxis_scrollbox, self.analysis_scan0P,
                                                   ...
                                                   self.x_axis_legend, self.y_axis_legends,
                                                   self.y_axis_legend, self.x_axis_datas,
                                                   self.x_axis_data_scan0P, self.qpr,
        ...
        # Get canal value
        self.canal_scan0P = graph_manager.get_canal(count)
    ...
    def show_spectrum(self):
        ...
        self.get_graph_parameters(final_path, count, from_classic_treatment=True)
    ...
    def create_plot(self, xaxis, yaxis, xlabel, ylabel, canal):
        ...
        self.add_title(self.ax, self.measurement_scrollbox)
        ...
        sns.lineplot(x=xaxis, y=yaxis, ax=self.ax, alpha=1, linewidth=0.7,
                     label=[self.record_type + ", " + self.qpr + ", " + canal + ", "
                            + self.measurement_scrollbox.currentText()])
